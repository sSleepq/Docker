...
```
<center><img src="src/image/1.png" style="width:500px; heigth:350px"></img></center>


### Параметр `-d` позволяет запустить контейнер в фоновом режиме
<center><img src="src/image/2.png" style="width:500px; heigth:350px"></img></center>
...
docker ps
```
<center><img src="src/image/3.png" style="width:500px; heigth:350px"></img></center>

### Параметр `-a` позволяет посмотреть список всех контейнеров
```bash
docker ps -a
```
<center><img src="src/image/4.png" style="width:500px; heigth:350px"></img></center>
